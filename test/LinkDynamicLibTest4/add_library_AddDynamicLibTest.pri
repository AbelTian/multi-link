...
defineTest(add_include_AddDynamicLibTest){
    ...
    #这里添加$${path}下的子文件夹
    #...
    header_path=$$get_add_include_bundle(AddDynamicLibTest, AddDynamicLibTest)
    command += $${header_path}
...
defineTest(add_library_AddDynamicLibTest){
    ...
    add_library_bundle(AddDynamicLibTest, AddDynamicLibTest)
...
defineTest(add_deploy_library_AddDynamicLibTest) {
    ...
    add_deploy_library_bundle(AddDynamicLibTest, AddDynamicLibTest)
