#----------------------------------------------------------------
#add_library_LinkDynamicLibTest.pri
#链接LinkDynamicLibTest组
...
defineTest(add_include_LinkDynamicLibTest){
    ...
    #isEmpty(1):header_path=$$get_add_include(LinkDynamicLibTest, LinkDynamicLibTest)
...
defineTest(add_defines_LinkDynamicLibTest){
    ...
    #--------------------------------------------
    #Multi-link 提供 LinkDynamicLibTest 的自有控制宏，
...
#留意
defineTest(add_library_LinkDynamicLibTest){
...
#留意
defineTest(add_deploy_library_LinkDynamicLibTest) {
