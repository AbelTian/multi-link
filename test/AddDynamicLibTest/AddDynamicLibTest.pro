...
add_sdk(AddDynamicLibTest, $$add_target_name())
#add_sdk_header_no_postfix(AddDynamicLibTest, $$add_target_name(), AddDynamicLibTest)

#-------------------------------------------------
#用户工程配置
#-------------------------------------------------
include($${PWD}/adddynamiclibtest_header.pri)
include($${PWD}/adddynamiclibtest_source.pri)

CONFIG += continue_build
contains(CONFIG, continue_build){
    system("touch $${PWD}/adddynamiclibtest.cpp")
}
